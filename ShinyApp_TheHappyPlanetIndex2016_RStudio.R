...
file_path <- "hpi-data-2016.xlsx"

data = read_xlsx(path = file_path, sheet = "data")
dataPlot = read_xlsx(path = file_path, sheet = "dataPlot")
dataCluster = read_xlsx(path = file_path, sheet = "Feuil1")
